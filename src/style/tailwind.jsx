const tailwind = {
  ...
  header: {
    App: "bg-slate-800 flex flex-col items-center font-mono",
    Tittle: "text-center mt-2 text-zinc-200 sm:text-5xl lg:text-7xl text-2xl hover:italic",
    Label: "flex mt-14 items-center text-center",
    ...
    NameInput: "w-36 ml-8 h-8 bg-slate-300 text-slate-500 rounded-md border-2 border-slate-600 hover:border-sky-300 hover:bg-sky-100",
    Subtittle: "text-center text-md sm:text-lg md:text-3xl hover:text-sky-200 text-lime-200",
    NavBar: "border-dotted fixed border mt-4 border-x-0 border-b-0 border-zinc-400 container flex flex-wrap justify-around items-center mx-auto",
