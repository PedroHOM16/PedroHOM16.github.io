...
export default function Header() {
  ...
  if (langLocalStorage === 'Port') {
    return (
      <div className='bg-slate-800 flex flex-col font-mono'>
        ...
        <p className='text-center text-md sm:text-lg md:text-3xl hover:text-sky-200 text-lime-200'>Olá {nameLocalStorage}, seja muito bem vindo(a)! &#128526;</p>
  ...
  return (
    ...
    <p className='text-center text-md sm:text-lg md:text-3xl hover:text-sky-200 text-lime-200'>Hello {nameLocalStorage}, welcome to my page! &#128526;</p>
    <div className='border-dotted border border-x-0 border-b-0 border-zinc-400 container flex flex-wrap justify-around items-center mx-auto'>
